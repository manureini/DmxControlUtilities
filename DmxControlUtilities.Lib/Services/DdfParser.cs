    ...
    public static class DdfParser
    {
        ...
        public static DeviceDescription Parse(XDocument pDoc, string pFilePath = "")
        {
            ...
            var description = new DeviceDescription
            {
                ...
                WhiteChannelDefaultMode = GetAttribute(root, "whitechanneldefaultmode") ?? string.Empty,
                AmberChannelDefaultMode = GetAttribute(root, "amberchanneldefaultmode") ?? string.Empty,
            };
